...
data2.to_csv("C:/Users/samue/Desktop/Assignments/Workspace/IA2/csvs/Pre_processed_Train_Data.csv", index=False)
#data2 = data2.insert(24,'price', data.iloc[:,20], allow_duplicates=False)
#print(data2)
...
data5.to_csv("C:/Users/samue/Desktop/Assignments/Workspace/IA2/csvs/Pre_processed_Train_Data.csv", index=False)
# print(data5)



# Save the new Data as a csv file
#data4.to_csv("C:/Users/samue/Desktop/Assignments/Workspace/IA1/csvs/Pre_Standardized_Data.csv", index=False)
